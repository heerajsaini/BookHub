...
import com.kartikey.myLib.database.BookDatabase
import com.kartikey.myLib.database.BookEntity
import com.kartikey.myLib.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
    ...
    class DBAsyncTask(@SuppressLint("StaticFieldLeak") val context: Context, val bookEntity: BookEntity, val mode: Int) :
